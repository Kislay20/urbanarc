...
export default function ShopPageClient({
  ...
  const all = initialProducts ?? getAllProducts();
  ...
  const initial: Filters = {
    category: initialCategory?.replace("-", " ") || search.get("category") || undefined,
  ...
  useEffect(() => {
    ...
    // use replace so back/forward works more naturally for filters
    router.replace(url);
